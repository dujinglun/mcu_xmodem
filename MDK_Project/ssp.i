...
#line 13 "..\\Common\\src\\ssp.c"
#line 1 "..\\Common\\inc\\ssp.h"
...
void SSP0_IRQHandler(void) 
{
  ...
  regValue = ((LPC_SSPx_Type *) (0x40040000))->MIS;
  if ( regValue & (1 << 0) )	 
  {
	interruptOverRunStat0++;
	((LPC_SSPx_Type *) (0x40040000))->ICR = (1 << 0);	 
  }
  if ( regValue & (1 << 1) )	 
  {
	interruptRxTimeoutStat0++;
	((LPC_SSPx_Type *) (0x40040000))->ICR = (1 << 1);	 
  }
...
void SSP1_IRQHandler(void) 
{
  ...
  regValue = ((LPC_SSPx_Type *) (0x40058000))->MIS;
  if ( regValue & (1 << 0) )	 
  {
	interruptOverRunStat1++;
	((LPC_SSPx_Type *) (0x40058000))->ICR = (1 << 0);	 
  }
  if ( regValue & (1 << 1) )	 
  {
	interruptRxTimeoutStat1++;
	((LPC_SSPx_Type *) (0x40058000))->ICR = (1 << 1);	 
  }
...
void SSP_IOConfig( uint8_t portNum )
{
  if ( portNum == 0 )
  {
	((LPC_SYSCON_Type *) (0x40048000))->PRESETCTRL |= (0x1<<0);
	((LPC_SYSCON_Type *) (0x40048000))->SYSAHBCLKCTRL |= (1<<11);
	((LPC_SYSCON_Type *) (0x40048000))->SSP0CLKDIV = 0x02;			 
	((LPC_IOCON_Type *) (0x40044000))->PIO0_8           &= ~0x07;	 
	((LPC_IOCON_Type *) (0x40044000))->PIO0_8           |= 0x01;		 
	((LPC_IOCON_Type *) (0x40044000))->PIO0_9           &= ~0x07;	
	((LPC_IOCON_Type *) (0x40044000))->PIO0_9           |= 0x01;		 
#line 132 "..\\Common\\src\\ssp.c"
	
 
	((LPC_IOCON_Type *) (0x40044000))->SCKLOC = 0x01;
	((LPC_IOCON_Type *) (0x40044000))->PIO2_11 = 0x01;	
 
#line 143 "..\\Common\\src\\ssp.c"
	...
	((LPC_IOCON_Type *) (0x40044000))->PIO0_2 &= ~0x07;		 
  ...
  {
	((LPC_SYSCON_Type *) (0x40048000))->PRESETCTRL |= (0x1<<2);
	((LPC_SYSCON_Type *) (0x40048000))->SYSAHBCLKCTRL |= (1<<18);
	((LPC_SYSCON_Type *) (0x40048000))->SSP1CLKDIV = 0x02;			 
	((LPC_IOCON_Type *) (0x40044000))->PIO2_2 &= ~0x07;	 
	((LPC_IOCON_Type *) (0x40044000))->PIO2_2 |= 0x02;		 
	((LPC_IOCON_Type *) (0x40044000))->PIO2_3 &= ~0x07;	
	((LPC_IOCON_Type *) (0x40044000))->PIO2_3 |= 0x02;		 
	((LPC_IOCON_Type *) (0x40044000))->PIO2_1 &= ~0x07;
	((LPC_IOCON_Type *) (0x40044000))->PIO2_1 |= 0x02;		 
	...
	((LPC_IOCON_Type *) (0x40044000))->PIO2_0 &= ~0x07;		 
...
void SSP_Init( uint8_t portNum )
{
  ...
  if ( portNum == 0 )
  {
	...
	((LPC_SSPx_Type *) (0x40040000))->CR0 = 0x0707;

	 
	((LPC_SSPx_Type *) (0x40040000))->CPSR = 0x2;

	for ( i = 0; i < 8; i++ )
	{
	  Dummy = ((LPC_SSPx_Type *) (0x40040000))->DR;		 
	}
	...
	((LPC_SSPx_Type *) (0x40040000))->CR1 = (1 << 0) | (1 << 1);
#line 232 "..\\Common\\src\\ssp.c"
	 
	 
	((LPC_SSPx_Type *) (0x40040000))->IMSC = (1 << 0) | (1 << 1);
  }
  else
  {
	 
	((LPC_SSPx_Type *) (0x40058000))->CR0 = 0x0707;

	 
	((LPC_SSPx_Type *) (0x40058000))->CPSR = 0x2;

	for ( i = 0; i < 8; i++ )
	{
	  Dummy = ((LPC_SSPx_Type *) (0x40058000))->DR;		 
	}
	...
	((LPC_SSPx_Type *) (0x40058000))->CR1 = (1 << 0) | (1 << 1);
#line 270 "..\\Common\\src\\ssp.c"
	 
	 
	((LPC_SSPx_Type *) (0x40058000))->IMSC = (1 << 0) | (1 << 1);
  }
  return;
}
...
void SSP_Send( uint8_t portNum, uint8_t *buf, uint32_t Length )
{
  ...
  for ( i = 0; i < Length; i++ )
  {
	if ( portNum == 0 )
	{
	  ...
	  while ( (((LPC_SSPx_Type *) (0x40040000))->SR & ((1 << 1)|(1 << 4))) != (1 << 1) );
	  ((LPC_SSPx_Type *) (0x40040000))->DR = *buf;
	  buf++;
#line 308 "..\\Common\\src\\ssp.c"
	   
	  while ( ((LPC_SSPx_Type *) (0x40040000))->SR & (1 << 4) );

	}
	else
	{
	   
	  while ( (((LPC_SSPx_Type *) (0x40058000))->SR & ((1 << 1)|(1 << 4))) != (1 << 1) );
	  ((LPC_SSPx_Type *) (0x40058000))->DR = *buf;
	  buf++;
#line 325 "..\\Common\\src\\ssp.c"
...
void SSP_Receive( uint8_t portNum, uint8_t *buf, uint32_t Length )
{
  ...
  for ( i = 0; i < Length; i++ )
  {
	...
	if ( portNum == 0 )
	{
#line 364 "..\\Common\\src\\ssp.c"
	  while ( !(((LPC_SSPx_Type *) (0x40040000))->SR & (1 << 2)) );

	  *buf = ((LPC_SSPx_Type *) (0x40040000))->DR;
	  buf++;
	}
	else
	{
#line 380 "..\\Common\\src\\ssp.c"
	  while ( !(((LPC_SSPx_Type *) (0x40058000))->SR & (1 << 2)) );

	  *buf = ((LPC_SSPx_Type *) (0x40058000))->DR;
	  buf++;
	}
  }
  return; 
