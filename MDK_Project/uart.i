...
#line 24 "..\\Common\\src\\uart.c"
#line 1 "..\\userinc\\Xmodem128.h"


typedef		struct	
{
	  uint8_t		StartOfHeader;		   
	  uint8_t		PacketNumber1;		   
...
#line 24 "..\\userinc\\Xmodem128.h"
uint8_t	XMODE_ReceiveData(uint8_t Order);

 


#line 25 "..\\Common\\src\\uart.c"
#line 31 "..\\Common\\src\\uart.c"
volatile 	uint8_t  		UARTBuffer[(sizeof(XMODEM128))];
...
void UART_IRQHandler(void)
{
  ...
  IIRValue = ((LPC_USART_Type *) (0x40008000))->IIR;
    
  IIRValue >>= 1;			 
  IIRValue &= 0x07;			 
  if (IIRValue == 0x03)   
  {
    LSRValue = ((LPC_USART_Type *) (0x40008000))->LSR;
     
    if (LSRValue & ((0x01<<1) | (0x01<<2) | (0x01<<3) | (0x01<<7) | (0x01<<4)))
    {
       
       
      UARTStatus = LSRValue;
      Dummy = ((LPC_USART_Type *) (0x40008000))->RBR;	
    ...
    if (LSRValue & (0x01<<0))	 			
    {
	  ...
	  if(XmodemRec->RecEn ==0x01)
	  {
		  ...
		  UARTBuffer[ XmodemRec->Count++ ]	=((LPC_USART_Type *) (0x40008000))->RBR;
		  if( XmodemRec->Count >= 133)			 
		  {
		  	   XmodemRec->Count	=0x00;
			   XmodemRec->RecEn =0xAA;					
		  }
	  }
	  else
	  {
...
void UARTInit(uint32_t baudrate)
{
  ...
  ((LPC_IOCON_Type *) (0x40044000))->PIO0_18 &= ~0x07;     
  ((LPC_IOCON_Type *) (0x40044000))->PIO0_18 |= 0x01;      
  ((LPC_IOCON_Type *) (0x40044000))->PIO0_19 &= ~0x07;	
  ((LPC_IOCON_Type *) (0x40044000))->PIO0_19 |= 0x01;      
#line 229 "..\\Common\\src\\uart.c"

   
  ((LPC_SYSCON_Type *) (0x40048000))->SYSAHBCLKCTRL |= (1<<12);
  ((LPC_SYSCON_Type *) (0x40048000))->UARTCLKDIV = 0x1;      

  ((LPC_USART_Type *) (0x40008000))->LCR = 0x83;              
  regVal = ((LPC_SYSCON_Type *) (0x40048000))->UARTCLKDIV;
  Fdiv = ((SystemCoreClock/regVal)/16)/baudrate ;	 

  ((LPC_USART_Type *) (0x40008000))->DLM = Fdiv / 256;							
  ((LPC_USART_Type *) (0x40008000))->DLL = Fdiv % 256;
  ((LPC_USART_Type *) (0x40008000))->LCR = 0x03;		 
  ((LPC_USART_Type *) (0x40008000))->FCR = 0x07;		 

   
  regVal = ((LPC_USART_Type *) (0x40008000))->LSR;

   
  while (( ((LPC_USART_Type *) (0x40008000))->LSR & ((0x01<<5)|(0x01<<6))) != ((0x01<<5)|(0x01<<6)) );
  while ( ((LPC_USART_Type *) (0x40008000))->LSR & (0x01<<0) )
  {
	regVal = ((LPC_USART_Type *) (0x40008000))->RBR;	 
  }
  ...
  ((LPC_USART_Type *) (0x40008000))->IER = (0x01<<0) | (0x01<<2);	 
...
{
    while((((LPC_USART_Type *) (0x40008000))->LSR & 0x60) != 0x60);
    ((LPC_USART_Type *) (0x40008000))->THR = Byte;
}
...
{
	  if(((LPC_USART_Type *) (0x40008000))->LSR & 0x01)
	  {
	  	*Byte = ((LPC_USART_Type *) (0x40008000))->RBR;
	  	 return 1;
	  }
	  	return 0;
}
