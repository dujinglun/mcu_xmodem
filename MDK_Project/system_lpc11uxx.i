#line 1 "..\\Common\\src\\system_LPC11Uxx.c"
...
#line 27 "..\\Common\\src\\system_LPC11Uxx.c"
...
#line 28 "..\\Common\\src\\system_LPC11Uxx.c"
...
#line 156 "..\\Common\\src\\system_LPC11Uxx.c"
...
#line 258 "..\\Common\\src\\system_LPC11Uxx.c"

   
#line 267 "..\\Common\\src\\system_LPC11Uxx.c"



   
#line 286 "..\\Common\\src\\system_LPC11Uxx.c"
...
uint32_t SystemCoreClock = ((((( (12000000UL))) * ((0x00000023 & 0x01F) + 1))) / 0x00000001); 
...
void SystemCoreClockUpdate (void)             
{
  ...
  switch ((((LPC_SYSCON_Type *) (0x40048000))->WDTOSCCTRL >> 5) & 0x0F) {
  ...
  wdt_osc /= ((((LPC_SYSCON_Type *) (0x40048000))->WDTOSCCTRL & 0x1F) << 1) + 2;
 
  switch (((LPC_SYSCON_Type *) (0x40048000))->MAINCLKSEL & 0x03) {
    case 0:                              
      SystemCoreClock = (12000000UL);
      break;
    case 1:                              
      switch (((LPC_SYSCON_Type *) (0x40048000))->SYSPLLCLKSEL & 0x03) {
          case 0:                        
            SystemCoreClock = (12000000UL);
            break;
          case 1:                        
    ...
    case 3:                              
      switch (((LPC_SYSCON_Type *) (0x40048000))->SYSPLLCLKSEL & 0x03) {
          case 0:                        
            if (((LPC_SYSCON_Type *) (0x40048000))->SYSPLLCTRL & 0x180) {
              SystemCoreClock = (12000000UL);
            } else {
              SystemCoreClock = (12000000UL) * ((((LPC_SYSCON_Type *) (0x40048000))->SYSPLLCTRL & 0x01F) + 1);
            }
            break;
          case 1:                        
            if (((LPC_SYSCON_Type *) (0x40048000))->SYSPLLCTRL & 0x180) {
  ...
  SystemCoreClock /= ((LPC_SYSCON_Type *) (0x40048000))->SYSAHBCLKDIV;  
...
void SystemInit (void) {
  ...
  ((LPC_SYSCON_Type *) (0x40048000))->PDRUNCFG     &= ~(1 << 5);           
  ((LPC_SYSCON_Type *) (0x40048000))->SYSOSCCTRL    = 0x00000000;
  for (i = 0; i < 200; i++) __nop();


  ((LPC_SYSCON_Type *) (0x40048000))->SYSPLLCLKSEL  = 0x00000001;    
  ((LPC_SYSCON_Type *) (0x40048000))->SYSPLLCLKUEN  = 0x01;                
  ((LPC_SYSCON_Type *) (0x40048000))->SYSPLLCLKUEN  = 0x00;                
  ((LPC_SYSCON_Type *) (0x40048000))->SYSPLLCLKUEN  = 0x01;
  while (!(((LPC_SYSCON_Type *) (0x40048000))->SYSPLLCLKUEN & 0x01));      

  ((LPC_SYSCON_Type *) (0x40048000))->SYSPLLCTRL    = 0x00000023;
  ((LPC_SYSCON_Type *) (0x40048000))->PDRUNCFG     &= ~(1 << 7);           
  while (!(((LPC_SYSCON_Type *) (0x40048000))->SYSPLLSTAT & 0x01));	       
  ...
  ((LPC_SYSCON_Type *) (0x40048000))->MAINCLKSEL    = 0x00000003;      
  ((LPC_SYSCON_Type *) (0x40048000))->MAINCLKUEN    = 0x01;                
  ((LPC_SYSCON_Type *) (0x40048000))->MAINCLKUEN    = 0x00;                
  ((LPC_SYSCON_Type *) (0x40048000))->MAINCLKUEN    = 0x01;
  while (!(((LPC_SYSCON_Type *) (0x40048000))->MAINCLKUEN & 0x01));        

  ((LPC_SYSCON_Type *) (0x40048000))->SYSAHBCLKDIV  = 0x00000001;


  ((LPC_SYSCON_Type *) (0x40048000))->PDRUNCFG     &= ~(1 << 10);          


  ((LPC_SYSCON_Type *) (0x40048000))->PDRUNCFG     &= ~(1 <<  8);          
  ((LPC_SYSCON_Type *) (0x40048000))->USBPLLCLKSEL  = 0x00000001;    
  ((LPC_SYSCON_Type *) (0x40048000))->USBPLLCLKUEN  = 0x01;                
  ((LPC_SYSCON_Type *) (0x40048000))->USBPLLCLKUEN  = 0x00;                
  ((LPC_SYSCON_Type *) (0x40048000))->USBPLLCLKUEN  = 0x01;
  while (!(((LPC_SYSCON_Type *) (0x40048000))->USBPLLCLKUEN & 0x01));      
  ((LPC_SYSCON_Type *) (0x40048000))->USBPLLCTRL    = 0x00000023;
  while (!(((LPC_SYSCON_Type *) (0x40048000))->USBPLLSTAT   & 0x01));      
  ((LPC_SYSCON_Type *) (0x40048000))->USBCLKSEL     = 0x00;                


  ((LPC_SYSCON_Type *) (0x40048000))->USBCLKSEL     = 0x00000000;       
  ((LPC_SYSCON_Type *) (0x40048000))->USBCLKDIV     = 0x00000001;       
  ...
  ((LPC_SYSCON_Type *) (0x40048000))->SYSAHBCLKCTRL |= (1<<16);
