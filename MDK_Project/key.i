...
void	Key_Init(void)
{
	((LPC_IOCON_Type *) (0x40044000))->TDO_PIO0_13	|=0x01;	
	GPIOSetDir( 0, 	7, 	0 );
	GPIOSetDir( 0, 	8, 	0 );
	GPIOSetDir( 0, 	9, 	0 );
	GPIOSetDir( 0, 	13, 	0 );			
...
uint8_t	Key_GetValue(void)
{
		...
		uint8_t		KeyValue;
		PinValue	=((LPC_GPIO_Type *) (0x50000000))->PIN[ 0 ] & (1 | (1<<7) | (1<<8) | (1<<9) | (1<<13));
		if( PinValue != (1 | (1<<7) | (1<<8) | (1<<9) | (1<<13)))
		{
			 Key_Delay();
			 PinValue	=((LPC_GPIO_Type *) (0x50000000))->PIN[ 0 ] & (1 | (1<<7) | (1<<8) | (1<<9) | (1<<13));
			 do
			 {
			 	   Temp	=((LPC_GPIO_Type *) (0x50000000))->PIN[ 0 ] & (1 | (1<<7) | (1<<8) | (1<<9) | (1<<13));
			 }while(Temp != (1 | (1<<7) | (1<<8) | (1<<9) | (1<<13)));
			 switch( PinValue ^ (1 | (1<<7) | (1<<8) | (1<<9) | (1<<13)))
			 {
			 	case (1<<7):	KeyValue	=1;	break;
				case (1<<8):	KeyValue	=2;	break;
				case (1<<9):	KeyValue	=3;	break;
				case (1<<13):	KeyValue	=4;	break;
